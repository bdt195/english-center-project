        ...
        <ul class="sidebar-menu" data-widget="tree">
            ...
            <li class="treeview">
              ...
              <i class="fa fa-angle-left pull-right"></i>
                ...
                <ul class="treeview-menu">
                    <li><a href="/admin/category/create"><i class="fa fa-circle-o"></i> New Category</a></li>
                    <li><a href="/admin/category"><i class="fa fa-circle-o"></i> Category</a></li>
                    <li><a href="/admin/post/create"><i class="fa fa-circle-o"></i> New Post</a></li>
            ...
            <li class="treeview">
              ...
              <i class="fa fa-angle-left pull-right"></i>
                ...
                <ul class="treeview-menu">
                    <li><a href="index.html"><i class="fa fa-circle-o"></i> New Test</a></li>
